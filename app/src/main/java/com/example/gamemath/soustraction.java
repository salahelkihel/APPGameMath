...
public class soustraction extends AppCompatActivity {
            ...
            public void run(){
                try{
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            button1.setBackgroundResource(R.drawable.bg_bns);
                            button2.setBackgroundResource(R.drawable.bg_bns);
                            button3.setBackgroundResource(R.drawable.bg_bns);
                            button4.setBackgroundResource(R.drawable.bg_bns);
                            cmp++;
                            if (cmp==16){nbr.setText("15/15");}
                            else { nbr.setText(cmp+"/15");}

                            if (cmp==16){
                                final AlertDialog.Builder builder =new AlertDialog.Builder(soustraction.this);
                                ...
                                if(!button2.getText().equals(Integer.toString(res))){
                                    button2.setText(Integer.toString(res+1));
                                }
                                if(!button3.getText().equals(Integer.toString(res))){
                                    button3.setText(Integer.toString(res+2));
                                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1=findViewById(R.id.button1so);
        button2=findViewById(R.id.button2so);
        button3=findViewById(R.id.button3so);
        button4=findViewById(R.id.button4so);
        T1=findViewById(R.id.textView1so);
        T2=findViewById(R.id.textView3so);
        nbr=findViewById(R.id.nbrso);
        ...
        chronometer=findViewById(R.id.chronometer4);
        chronometer.setBase(SystemClock.elapsedRealtime()+30000);
        chronometer.start();
