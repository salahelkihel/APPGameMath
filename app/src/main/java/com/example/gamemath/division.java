...
public class division extends AppCompatActivity {
            ...
            public void run(){
                try{
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            button1.setBackgroundResource(R.drawable.bg_bnd);
                            button2.setBackgroundResource(R.drawable.bg_bnd);
                            button3.setBackgroundResource(R.drawable.bg_bnd);
                            button4.setBackgroundResource(R.drawable.bg_bnd);
                            cmp++;
                            if (cmp==16){nbr.setText("15/15");}
                            else { nbr.setText(cmp+"/15");}

                            if (cmp==16){
                                final AlertDialog.Builder builder =new AlertDialog.Builder(division.this);
                                View layoutView = getLayoutInflater().inflate(R.layout.resulta, null);
                                builder.setView(layoutView);
                                Button qt = layoutView.findViewById(R.id.qt);
                                Button play = layoutView.findViewById(R.id.play);
                               TextView vrais =layoutView.findViewById(R.id.vr);
                               TextView faux=layoutView.findViewById(R.id.f);
                                 TextView scorimg =layoutView.findViewById(R.id.scorimg);
                                 TextView scortxt=layoutView.findViewById(R.id.scortext);
                                ...
                                if(!button1.getText().equals(Integer.toString(res))){
                                    button1.setText(Integer.toString(res+1));
                                }
    ...
    public void test (Button button){
        ...
        Integer re =Integer.parseInt(T1.getText().toString())/Integer.parseInt(T2.getText().toString());

        if (!button.getText().equals(Integer.toString(re))){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1=findViewById(R.id.button1di);
        button2=findViewById(R.id.button2di);
        button3=findViewById(R.id.button3di);
        button4=findViewById(R.id.button4di);
        T1=findViewById(R.id.textView1di);
        T2=findViewById(R.id.textView3di);
        nbr=findViewById(R.id.nbrdi);
